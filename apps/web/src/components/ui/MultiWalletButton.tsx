...
function WalletPill({
  ...
  return (
    <div ref={ref} style={{ position: 'relative' }}>
      ...
      >
        <span style={{ fontFamily: mono, fontSize: 9, fontWeight: 700, color: chainColor,
          padding: '1px 5px', background: `${chainColor}18`, borderRadius: 3 }}>
          {chain}
        </span>
          ...
          {!hasEVM && (
            ...
            >
              <div style={{
                ...
                <span style={{ fontFamily: mono, fontSize: 8, fontWeight: 900, color: '#F3BA2F' }}>BSC</span>
              </div>
              <div>
          ...
          {!hasSOL && (
            ...
            >
              <div style={{
                ...
                <span style={{ fontFamily: mono, fontSize: 8, fontWeight: 900, color: '#9945FF' }}>SOL</span>
              </div>
              <div>
                <div style={{ fontFamily: mono, fontSize: 12, fontWeight: 700, color: '#F9FAFB', marginBottom: 2 }}>
                  Solana Wallet
